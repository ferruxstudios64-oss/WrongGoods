...
const results=await Promise.allSettled(['/styles.css','/app.js','/assets/dayshift.webp','/assets/wronggoods-wordmark.svg','/privacy.html','/favicon.svg','/robots.txt'].map(path=>check(path,200)));for(const result of results)if(result.status==='rejected')throw result.reason;
